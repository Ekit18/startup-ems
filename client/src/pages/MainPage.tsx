...
import { AWS_STATIC_FILES_ROUTE, CHAT_GPT_ROUTE, SERVICE_MAP_ROUTE, USER_MAP_ROUTE, REPAIR_SIGNING, AWS_ADD_STATIC_FILE_ROUTE, REPAIR_SEARCH } from '../utils/constants'
...
const MainPage: React.FC = observer(() => {
  ...
  return (
    <>
      ...
      <Button variant="danger" onClick={() => navigate(REPAIR_SEARCH)} className="me-5">Repair History Search</Button>
      <hr />
      <UserCars />
      {/* <RepairSigning/> */}
      <CreateCar />
